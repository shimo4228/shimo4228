...
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/shimo4228/shimo4228) [![GitMCP](https://img.shields.io/endpoint?url=https://gitmcp.io/badge/shimo4228/shimo4228)](https://gitmcp.io/shimo4228/shimo4228) [![View Code Wiki](https://assets.codewiki.google/readme-badge/static.svg)](https://codewiki.google/github.com/shimo4228/shimo4228)
...
A worked instance of that format sits beside it: [einstein-arena](https://github.com/shimo4228/einstein-arena). An autonomous agent, directed by the author and run under the same approval-gated harness, reached a server-verified top score on [EinsteinArena](https://einsteinarena.com)'s Prime Number Theorem construction problem — local score equal to the server's to all digits (0.9955806), beating the prior published best (0.994901) by +0.00068 while holding the clean upper bound the problem asks for (g(x) ≤ 1) rather than the tiny 1.0001 numerical slack the prior top relied on — a stricter, more honest construction. The author holds no degree or research background in mathematics or numerical optimization; the verifiable artifact exists anyway — the AI was the path, and the result is the author's to account for. It is filed as Existence Proof Format instance #1, anchored to the public repository and the arena platform — not a research line and not a component skill, just a witness.
